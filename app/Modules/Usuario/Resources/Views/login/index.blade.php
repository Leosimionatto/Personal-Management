...
@section('content')
    <div class="center-page">
        <div class="card relative" style="width:700px;background:#fff;">
            <div class="padding-10 width-30 align-top inline-block" style="position:absolute;top:0;bottom:0;left:0;background:#628D6E;">
                <div class="block padding-12 text-center">
                    ...
                    <div class="social-icons space-top-10" style="position:absolute;bottom:10px;right:0;left:0;">
                        <div class="icon">
            ...
            <div class="padding-12 width-70 inline-block align-top" style="margin-left:29.5%;min-height:350px;max-height:395px;">
                <div class="card-header padding-4">
                    <i class="fa fa-key dark-green-color right" style="font-size:18px"></i>
                    <h3>Personal <span class="dark-green-color" style="font-size:20px">Management</span> - Autenticação</h3>
                </div>
                <div class="card-body space-top-6">
                    <div class="padding-4">
                        ...
                        <form action="{{ url('usuario/login') }}" method="POST" class="login-form">
                            ...
                            <div class="form-group space-top-6">
                    ...
                    <div class="space-top-10 align-center">
                        ...
                        <button class="success-button call-confirm-modal right submit">Efetuar o login <i class="fa fa-user-circle white"></i></button>
                    </div>
                </div>
            </div>
        </div>
