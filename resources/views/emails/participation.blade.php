        ...
        <tbody>
            ...
            <tr>
                <td style="text-align:left;padding:14px;border-bottom:1px solid #e7e7e7">
                    <p style="font-size:16px;font-family:'Calibri Light', sans-serif !important;margin:0;"><b>Olá, {{ $data['nmparticipante'] }}!</b></p>
                    <p style="font-family:'Calibri Light', sans-serif !important;font-size:14px;">
                        ...
                        <a href="{{ route('project.participation.request', $data['token']) }}">clicar aqui</a>
                    </p>
